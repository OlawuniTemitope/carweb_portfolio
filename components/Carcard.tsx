...
import CarDedail from './CarDedail'
interface cardCarProps{
  car:carProp
}

function Carcard({car}:cardCarProps) {
 ...
 const {city_mpg, 
  ...
  return (
    <div className='car-card group'>
      ...
      <p className=' flex mt-6 text-[32pxx] 
      font-extrabold'>
      ...
      <div className='relative flex w-full mt-2'>
        ...
        <div className='car-card__btn-container'>
          <CustomButon title='View more' containerStyles='w-full py-[16px]
          rounded-full bg-primary-blue' 
          textStyles='text-white text-[14px]
           leasing-[17px] font-bold'
           rightIcon='/right-arrow.svg'
           handleClick={()=>setIsOpen(true)}/>
        </div>
      </div>
      <CarDedail isOpen={isOpen}
